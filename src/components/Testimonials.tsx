...
export const Testimonials = () => {
  const testimonials = [
    {
      ...
      content: 'Krishna Bhat Mill Stores has been our trusted partner for over 15 years. Their quality products and timely delivery have never let us down, even during critical project deadlines.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The technical expertise and product knowledge of their team is outstanding. They always recommend the right solutions for our construction projects, helping us maintain quality standards.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'From small fasteners to heavy-duty equipment, Krishna Bhat Mill Stores consistently delivers. Their emergency supply service has saved our operations multiple times.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Three generations of reliable service! The quality assurance and after-sales support make them our preferred industrial supplier. Highly recommended for all industrial needs.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Their vast inventory and quick response time are impressive. Whether it\'s routine maintenance or emergency requirements, they always deliver on time with quality products.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Professional service with competitive pricing. Their technical support team helps us select the right products for our specific applications. Excellent partnership for 10+ years.',
      rating: 5,
  ...
  const renderStars = (rating: number) => {
    return Array.from({ length: 5 }).map((_, index) => (
      <Star 
        key={index} 
        className={`h-4 w-4 ${index < rating ? 'text-yellow fill-yellow' : 'text-gray-300'}`} 
      />
    ));
  };
  ...
  return (
    <section className="py-16 lg:py-24 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        {/* Trust Statistics */}
        <div className="mt-16 bg-navy text-white rounded-2xl p-8 lg:p-12">
          <div className="text-center mb-8">
            ...
            <p className="font-open-sans text-white/90 max-w-2xl mx-auto">
              78 years of building relationships and delivering excellence across diverse industrial sectors.
            </p>
          </div>
