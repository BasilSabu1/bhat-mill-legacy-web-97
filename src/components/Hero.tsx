...
export const Hero = () => {
  return (
    <section id="home" className="relative bg-gradient-to-r from-navy to-navy/90 text-white py-20 lg:py-32 overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center bg-yellow/20 text-yellow px-4 py-2 rounded-full mb-6">
            <span className="font-montserrat font-medium text-sm">Est. 1946 • 78+ Years of Excellence</span>
          </div>
          ...
          <p className="font-open-sans text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
            Kerala's trusted source for premium industrial supplies, fasteners, valves, 
            and hand tools. Three generations of reliability and quality service.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-2 border-white text-white hover:bg-white hover:text-navy font-montserrat font-semibold text-lg px-8 py-4 h-auto group"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16 pt-8 border-t border-white/20">
            <div className="text-center">
              <div className="font-montserrat font-bold text-3xl text-yellow mb-2">10,000+</div>
              <div className="font-open-sans text-white/80">Products Available</div>
            </div>
            <div className="text-center">
              <div className="font-montserrat font-bold text-3xl text-yellow mb-2">5,000+</div>
              <div className="font-open-sans text-white/80">Satisfied Customers</div>
            </div>
            <div className="text-center">
